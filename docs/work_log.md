...
## Getting started
- Structured the repo as a mixed C++ and Python monorepo, with first-party runtime
  code in top-level project directories and vendored stacks under `thirdparty/`
- Followed https://modal.com/docs/examples/vllm_inference for
  `seceda_cloud/vllm_inference.py`
